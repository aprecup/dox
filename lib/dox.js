...
exports.parseComment = function(str, options) {
  ...
  // markdown
  if (!raw) {
    description.full = markdown.parse(description.full);
    description.summary = markdown.parse(description.summary);
    description.body = markdown.parse(description.body);
  }
